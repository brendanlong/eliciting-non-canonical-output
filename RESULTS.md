...
CJK than SFT). Whether the Dolci-Think-DPO chosen responses contain more
CJK than the rejected ones is a direct check on the training data that
was not run here.
...
*Notes from Claude:* this is the cleanest statement of the two
