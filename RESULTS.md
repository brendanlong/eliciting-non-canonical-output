...
under each context. Cells: the four with strong clustering above
(remaining cells are added as they land).

<details><summary>Generated by</summary>

```
uv run python -m noncanon.divergence summarize --contagion "Think-DPO=out/divergence/think-dpo"
```
