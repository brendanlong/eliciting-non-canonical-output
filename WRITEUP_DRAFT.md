...
**Figure 4.** Same text, two id sequences: emitted versus canonical from the span on. Top: how often the next-token argmax differs, by distance after the span. Bottom: median KL between the two next-token distributions.
